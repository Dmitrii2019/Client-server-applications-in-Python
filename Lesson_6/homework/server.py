...
import homework.logs.decorator_log_config
import homework.logs.server_log_config
...
from homework.errors import IncorrectDataRecivedError
from homework.my_decorator.logs import log
...
def process_client_message(message):
    ...
    : param message: прописать пораметры!!!
    : return: RESPONSE: 200
    : return: RESPONSE_DEFAULT_IP_ADDRESS: 400, ERROR: 'Bad Request.'
    """
    if (
            ACTION in message and message[ACTION] == PRESENCE and TIME in message
...
def main():
    ...
    while True:
        ...
        try:
            ...
            client.close()
        except IncorrectDataRecivedError(ValueError, json.JSONDecodeError):
