...
from common.settings import (ACCOUNT_NAME, ACTION, DEFAULT_PORT,
                             ERROR, MAX_CONNECTIONS, PRESENCE,
                             TIME, USER, MESSAGE,
                             MESSAGE_TEXT, SENDER, RESPONSE_400, DESTINATION, RESPONSE_200, EXIT)
...
def customer_distribution(clients):
    recv_data_lst = []
    send_data_lst = []
    err_lst = []
